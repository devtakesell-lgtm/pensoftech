    ...
    <div class="max-w-7xl mx-auto px-5 lg:px-12">
                ...
                <a href="/" class="inline-flex items-center gap-3 text-white text-xl md:text-2xl font-bold mb-4">
                    ...
                    @else
                        <div
                            ...
                            {{ substr(setting('company_name', 'P'), 0, 1) }}
                        </div>
                    @endif
                    <span>{{ setting('company_name', 'Pensoftech') }}</span>
                </a>
                <p class="text-gray-400 text-xs sm:text-sm leading-relaxed mb-6 max-w-sm">
                    {{ setting('sort_bio', 'Pensoftech specializes in launching and scaling world-class B2B SaaS platforms with expert product, engineering, and growth strategies.') }}
                </p>
                <div class="flex flex-col gap-2 text-xs sm:text-sm text-gray-300">
                    <a href="mailto:{{ setting('contact_email', 'hello@pensoftech.com') }}"
                        ...
                        {{ setting('contact_email', 'hello@pensoftech.com') }}
                    </a>
                    <span class="inline-flex items-center gap-2 text-gray-400">
                        ...
                        {{ setting('office_location', 'San Francisco, CA & Dhaka, BD') }}
                    </span>
                </div>
            </div>
        ...
        <div
            ...
            <p class="text-gray-500 text-xs sm:text-sm text-center sm:text-left">
                &copy; {{ date('Y') }} {{ setting('company_name', 'Pensoftech Inc.') }} All Rights Reserved.
