                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="mb-4">
                            ...
                            <input type="text" name="meta_title" id="meta_title" class="form-control" value="{{ old('meta_title') }}" placeholder="Leave blank to use Page Title">
                            @error('meta_title')
                                <div class="text-danger small mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-0">
                            ...
                            <input type="text" name="meta_keywords" id="meta_keywords" class="form-control" value="{{ old('meta_keywords') }}" placeholder="e.g. web design, seo, digital marketing">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="template" id="template" class="form-select" required>
                                ...
                                <option value="contact" {{ old('template') === 'contact' ? 'selected' : '' }}>Contact Page</option>
                            </select>
                            @error('template')
                                <div class="text-danger small mt-1">{{ $message }}</div>
                            @enderror
