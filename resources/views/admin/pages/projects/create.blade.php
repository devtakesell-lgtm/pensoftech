...
@section('content')
    <div class="heading">
        <div>
            ...
            <p>Register a new client project, set status, assign industries and services.</p>
        </div>
        <div>
        ...
        <div class="card form-card mb-4">
            ...
            <div class="form-grid-2">
                <div class="form-group">
                    ...
                    <input type="text" name="title" value="{{ old('title') }}" placeholder="e.g. Website Redesign"
            ...
            <div class="form-group mt-3">
                ...
                <textarea name="short_description" rows="2" class="form-textarea" placeholder="Brief summary of the project...">{{ old('short_description') }}</textarea>
            </div>
                    ...
                    <select name="status" class="form-input" required>
                        @foreach ($statuses ?? [] as $statusOption)
                            <option value="{{ $statusOption->value }}"
                                {{ old('status', 'upcoming') === $statusOption->value ? 'selected' : '' }}>
                                {{ $statusOption->label() }}
                            </option>
                        @endforeach
                    </select>
        ...
        <div class="card form-card mb-4">
            ...
            <div class="form-grid-3">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="completion_date" value="{{ old('completion_date') }}" class="form-input">
                </div>
