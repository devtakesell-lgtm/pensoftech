                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                <label for="challenge" class="form-label fw-semibold">The Challenge <span
                                        class="text-danger">*</span></label>
                                <textarea name="challenge" id="challenge" class="form-control" rows="4" required>{{ old('challenge', $caseStudy->challenge) }}</textarea>
                            </div>
                            <div class="col-md-6 mb-4">
                                <label for="solution" class="form-label fw-semibold">Our Solution <span
                                        class="text-danger">*</span></label>
                                <textarea name="solution" id="solution" class="form-control" rows="4" required>{{ old('solution', $caseStudy->solution) }}</textarea>
                            </div>
                        </div>
