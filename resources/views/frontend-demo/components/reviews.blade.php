<section class="bg-[#f9fafb] py-24 md:py-32 overflow-hidden border-t border-gray-100">
    <div class="max-w-7xl mx-auto px-6 lg:px-12 mb-16 text-center">
        <span class="text-[#4fd1c5] font-bold tracking-widest uppercase text-sm mb-4 block">Customer Reviews</span>
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-12">
        <div class="swiper reviews-swiper overflow-hidden rounded-2xl w-full pb-12">
            <div class="swiper-wrapper">
                
                @foreach($reviews as $review)
                <div class="swiper-slide !w-[320px] md:!w-[400px]" data-cursor-expand>
                    <div class="bg-white rounded-3xl p-8 border border-gray-100 shadow-[0_8px_30px_rgba(0,0,0,0.04)] h-full flex flex-col">
                        
                        {{-- Stars --}}
                        <div class="flex gap-1 text-[#facc15] mb-6">
                            @for($i=0; $i<5; $i++)
                        ...
                        {{-- Review Text --}}
                        <p class="text-gray-700 text-lg mb-8 flex-grow leading-relaxed">
                            "{{ $review['text'] }}"
                        </p>

                        {{-- User Info --}}
                        <div class="flex items-center gap-4 mt-auto">
                            <img src="{{ $review['img'] }}" alt="{{ $review['name'] }}" class="w-12 h-12 rounded-full object-cover shadow-sm">
                            <div>
