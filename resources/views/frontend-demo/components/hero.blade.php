<section class="relative w-full h-screen overflow-hidden bg-black flex items-center justify-center">
    ...
    {{-- Content --}}
    <div class="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-12 flex flex-col justify-end h-full pb-32">
        <div class="max-w-4xl">
            <h1 class="text-white text-5xl md:text-7xl lg:text-[8rem] font-bold tracking-tighter leading-[0.9] uppercase">
            ...
            <p class="hero-subtext mt-8 text-lg md:text-2xl text-white/80 max-w-2xl font-medium opacity-0 translate-y-4">
                Asia's fastest-growing IT ecosystem. We build custom software and digital marketing engines that scale enterprise revenue.
            </p>
            <div class="hero-buttons mt-10 flex gap-4 opacity-0 translate-y-4">
                <a href="#ecosystem" data-cursor-expand class="px-8 py-4 bg-white text-black font-semibold rounded-full hover:bg-[#4fd1c5] hover:text-white transition-colors duration-300">
                    Explore Ecosystem
                </a>
                <a href="#work" data-cursor-expand class="px-8 py-4 bg-white/10 border border-white/20 text-white font-semibold rounded-full hover:bg-white/20 transition-colors duration-300 backdrop-blur-sm">
                    View Our Work
                </a>
            </div>
        </div>
