    ...
    <div class="max-w-7xl mx-auto px-5 lg:px-12 relative z-10">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            ...
            <div class="group relative p-[1px] rounded-2xl bg-white/5 hover:bg-gradient-to-br hover:from-[#4fd1c5]/50 hover:to-transparent transition-all duration-500 cursor-pointer">
                <div class="relative h-full bg-[#0a0a0a] rounded-2xl p-5 md:p-8 overflow-hidden transition-all duration-500 group-hover:bg-[#0a0a0a]/90">
                    ...
                    <div class="relative z-10">
                        <div class="w-11 h-11 md:w-14 md:h-14 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-2xl md:text-3xl mb-4 md:mb-6 group-hover:border-[#4fd1c5]/30 group-hover:scale-110 transition-all duration-300">
                            {{ $industry['icon'] }}
                        </div>
                        <h3 class="text-lg md:text-xl font-bold text-white mb-2 md:mb-3 group-hover:text-[#4fd1c5] transition-colors duration-300">{{ $industry['title'] }}</h3>
                        <p class="text-gray-400 text-xs md:text-sm leading-relaxed group-hover:text-gray-300 transition-colors duration-300">
                            {{ $industry['desc'] }}
                        </p>
                    </div>

                    {{-- Corner arrow --}}
                    <div class="absolute top-5 right-5 md:top-6 md:right-6 opacity-0 translate-x-2 -translate-y-2 group-hover:opacity-100 group-hover:translate-x-0 group-hover:translate-y-0 transition-all duration-300 text-[#4fd1c5]">
